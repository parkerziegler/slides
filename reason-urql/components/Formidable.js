...
const Formidable = () => (
  <Background>
    <svg
      ...
      role="presentation"
    >
      <polygon points="58 1 7.492 46.634 58 63.634 58 1" fill="#fff" />
      <polygon
        points="58 1 93.356 18.638 58 63.634 58 1"
        opacity="0.75"
        fill="#fff"
      />
      <polygon
        points="58 99 93.356 18.638 58 63.634 58 99"
        opacity="0.5"
        fill="#fff"
      />
      <polygon
        points="7.492 46.634 58 63.634 58 99 7.492 46.634"
        opacity="0.25"
        fill="#fff"
      />
    </svg>
